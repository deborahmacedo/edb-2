...
int main(){
    ...
    std::cout << "---------------------------------------------------------------------------------------------------\n";
    std::cout << "\nInsertion Sort average time over 5 runs: " << insertion_average / 5 << " milliseconds" << std::endl;
    std::cout << "\nBubble Sort average time over 5 runs: " << bubble_average / 5 << " milliseconds" << std::endl;
    std::cout << "\nSequential Search average time over 5 runs: " << busca_sequencial_average / 5 << " milliseconds" << std::endl;
    std::cout << "\nBinary Search average time over 5 runs: " << busca_binaria_average / 5 << " milliseconds" << std::endl; 
