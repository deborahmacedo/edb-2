...
int main(){
       ...
       for(int j = 0; j < 5; ++j) { 
        ...
        for(int i = 0; i < 5; ++i) { 
            ...
            std::cout << "\nInsertion Sort execution time: " << duration_insertion.count() << " microseconds" << std::endl;
        ...
        std::cout << "---------------------------------------------------------------------------------------------------\n";
        std::cout << "\nInsertion Sort average time over 5 runs: " << insertion_average / 5 << " microseconds" << std::endl;
        std::cout << "\nBubble Sort average time over 5 runs: " << bubble_average / 5 << " microseconds" << std::endl;
        std::cout << "\nSequential Search average time over 5 runs: " << busca_sequencial_average / 5 << " microseconds" << std::endl;
        std::cout << "\nBinary Search average time over 5 runs: " << busca_binaria_average / 5 << " microseconds" << std::endl;
        std::cout << "\n"; 
